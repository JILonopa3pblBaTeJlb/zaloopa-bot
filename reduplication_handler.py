...
def lexical_reduplication(word):
    ...
    special_prefixes = {"ё": "хуё", "е": "хуе", "ю": "хую", "я": "хуя"}
    prefix = special_prefixes.get(mapped_vowel, "ху" + ("" if first_vowel_index == 1 else "й"))

    new_word = prefix + mapped_vowel + word[first_vowel_index:]
...
def reduplicate(update: Update, context: CallbackContext):
    ...
    if reduplicated_word:
        ...
        response = handle_debil_mode(reduplicated_word, context)
